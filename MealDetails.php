...
<html lang="en">
    <head>
        ...
        <style>
            ...
            .card-body {
                flex-grow: 1; /* Expands the body to fill available space */
                display: flex;
                flex-direction: column;
                justify-content: space-between; /* Ensures button is aligned at the bottom */
            }
                            ...
                            <div class="card d-flex flex-column h-100">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="bookmark-icon-container">
                                        <button class="btn btn-primary" onclick="openOffcanvas(<?php echo $i; ?>)">Add</button>
                                    </div>
